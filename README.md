...
- You can click on the crater and the spaceship. When you click on the spaceship, you can click on the button next to "Researching:" to pick a research. Until about 8 in-game days (~20 real-time minutes, this game runs 500x faster than real time) into the game, there won't be any interesting options. Do not press the "disable" button on the spaceship, as that basically softlocks the game.
...
- You can dismantle things via the trash button in the top right, but note that currently that only works in some cases, while other things just say "No people were found to destroy this." This is a bug that will be fixed at some point.
